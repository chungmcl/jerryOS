...
{
	return (void *)(uintptr)fdt_offset_ptr(fdt, offset, checklen);
}
 ...
 */
static inline u16 fdt16_ld(const fdt16_t *p)
{
...
static inline u32 fdt32_ld(const fdt32_t *p)
{
	const u8 *bp = (const u8 *)p;
...
static inline void fdt32_st(void *property, u32 value)
{
	u8 *bp = (u8 *)property;
...
static inline u64 fdt64_ld(const fdt64_t *p)
{
	const u8 *bp = (const u8 *)p;
...
static inline void fdt64_st(void *property, u64 value)
{
	u8 *bp = (u8 *)property;
...
int fdt_check_full(const void *fdt, size bufsize);
 ...
 */
int fdt_find_max_phandle(const void *fdt, u32 *phandle);
 ...
 */
static inline u32 fdt_get_max_phandle(const void *fdt)
{
	u32 phandle;
	int err;
 ...
 */
int fdt_generate_phandle(const void *fdt, u32 *phandle);
...
static inline struct fdt_property *fdt_get_property_by_offset_w(void *fdt,
								...
								int *lenp)
{
	return (struct fdt_property *)(uintptr)
...
fdt_get_property_namelen_w(void *fdt, int nodeoffset, const char *name,
			   int namelen, int *lenp)
{
	return (struct fdt_property *)(uintptr)fdt_get_property_namelen(
...
static inline void *fdt_getprop_namelen_w(void *fdt, int nodeoffset,
					  ...
					  int *lenp)
{
	return (void *)(uintptr)fdt_getprop_namelen(fdt, nodeoffset, name,
						      namelen, lenp);
}
#endif
...
static inline void *fdt_getprop_w(void *fdt, int nodeoffset,
				  const char *name, int *lenp)
{
	return (void *)(uintptr)fdt_getprop(fdt, nodeoffset, name, lenp);
}
 ...
 */
int fdt_create_with_flags(void *buf, int bufsize, u32 flags);
...
static inline int fdt_property_u32(void *fdt, const char *name, u32 val)
{
	fdt32_t tmp = cpu_to_fdt32(val);
	return fdt_property(fdt, name, &tmp, sizeof(tmp));
}
static inline int fdt_property_u64(void *fdt, const char *name, u64 val)
{
	fdt64_t tmp = cpu_to_fdt64(val);
	return fdt_property(fdt, name, &tmp, sizeof(tmp));
}
