...
{
	return (void *)(uintptr)fdt_offset_ptr_(fdt, offset);
}
...
{
	return (void *)(uintptr)fdt_mem_rsv_(fdt, n);
}
 ...
 * instead.
 */
static inline u32 fdt32_ld_(const fdt32_t *p)
{
	return fdt32_to_cpu(*p);
}

static inline u64 fdt64_ld_(const fdt64_t *p)
{
